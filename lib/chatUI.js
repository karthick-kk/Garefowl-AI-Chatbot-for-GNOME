...
export class ChatMessageDisplay {
    ...
    _createMessageBox(messageType, messageBoxType, text, backgroundColor, textColor) {
        ...
        const label = new St.Label({
            ...
            style: `background-color: ${backgroundColor}; color: ${textColor}; font-family: monospace;`,
            y_expand: true,
            x_expand: true,
            reactive: true,
        });
        ...
        label.clutter_text.selectable = false;

        // Convert markdown to Pango markup
        const markupText = convertMD(text || "[[EMPTY RESPONSE]]");
        label.clutter_text.set_markup(markupText);
